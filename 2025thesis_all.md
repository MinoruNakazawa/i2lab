...
- 佐古田知幹: NeRFを用いた3DCG空間におけるカモフラージュに関する研究 
...
### 修士大学院生
- 大田皐介: 局面に対応したコメント検索を用いた大規模言語モデルによる将棋解説文生成

- 田和広大: 3DLiDAR による交差点における歩行者・車両のトラッキングシステムの提案と評価

- 坂下水彩: 遠距離恋愛支援システムのスマホガジェットの開発

- 丸山洸青: 画像認識を用いた交差点上の歩行者・車両のトラッキングシステムの提案と評価

- 吾妻慶伍: 意思決定課題中の脳波を用いた個人別認知状態推定の統合的モデルの構築
