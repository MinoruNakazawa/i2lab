...
- 研究室説明会(専門ゼミ:研究室配属)の実施について
  - 2022年9月28日 20:00pm-21:00pm (JST)
   ...
   　　　``` 
        2023年度の3年生の研究室配属に係る内容について、中沢研究室は最大7名までゼミ生を受け入れる事をなりました。しかしながら、中沢自身は3月半ばまでアメリカ(RIT)に派遣されており、実質的な指導はオンラインとなります。(対面的な部分は学科主任・副主任に分担を頂きます。) また、研究室見学ができないため、どのような体制で行われるのかが不明であるため、以下の日程で研究室説明会を実施致しますので、ご都合のつく方はご参加ください。
        ``` 
  - 日曜日ということもあり、無理して聞く必要はないと思いますが、もし興味があって、どんな感じなのかを知りたい場合は参加してみてください。
